...
FONT_FILE_PATH=${4:-"${ROOT_DIR_PATH}asset/SourceHanSans-Bold.otf"}
SUBTITLE_MODE=${5:-"bottom"}

${ROOT_DIR_PATH}core/addSubtitle.sh $SUBTITLE_MOVIE_FILE_PATH $CONCAT_MOVIE_FILE_PATH $SUBTITLE_TEXT_FILE_PATH $FONT_FILE_PATH $SUBTITLE_MODE
