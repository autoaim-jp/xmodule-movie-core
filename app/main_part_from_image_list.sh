...
CENTER_BACKGROUND_IMAGE_FILE_PATH=${8:-"${SAMPLE_PROJECT_DIR_PATH}asset/background_1024.jpg"}
...
# フェード動画を作成し、ベース動画と結合
${ROOT_DIR_PATH}core/mergeBaseAndFadeMovie.sh $MOVIE_PART_LIST_FILE_PATH $MOVIE_PART_DIR_PATH $CENTER_IMAGE_LIST_FILE_PATH $BASE_PART_MOVIE_FILE_PATH $CENTER_BACKGROUND_IMAGE_FILE_PATH
