...
./app/speak_sound.sh "${TMP_DIR_PATH}__speak_sound.wav" "${TMP_DIR_PATH}__subtitle.csv" "${TMP_DIR_PATH}__image_list.csv" ./data/src/project/children_book_1/narration.csv ${PWD}/data/src/project/children_book_1/asset_ordered/
...
./app/main_part_from_image_list.sh "${TMP_DIR_PATH}__main_part_movie.mp4" "${TMP_DIR_PATH}__image_list.csv" ./data/src/project/children_book_1/bg_ccffcc.png x "${TMP_DIR_PATH}__black_white_title.png" x x
