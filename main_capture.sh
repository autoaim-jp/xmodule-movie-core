...
# debug
# TMP_SUBTITLE_FILE_PATH="${DATA_DIR_PATH}subtitle.csv"
...
${ROOT_DIR_PATH}app/title_movie.sh "$TMP_TITLE_MOVIE_FILE_PATH" "$TITLE_TEXT" "$TITLE_IMAGE_FILE_PATH" 4 "$FONT_FILE_PATH"
...
${ROOT_DIR_PATH}app/concat_movie.sh "$TMP_CONCAT_MOVIE_FILE_PATH" "$TMP_TITLE_MOVIE_FILE_PATH" "$CAPTURE_MOVIE_FILE_PATH" "$TMP_SOUND_FILE_PATH" "$ENDING_FILE_INDEX"

${ROOT_DIR_PATH}app/subtitle_movie.sh "$OUTPUT_MOVIE_FILE_PATH" "$TMP_CONCAT_MOVIE_FILE_PATH" "$TMP_SUBTITLE_FILE_PATH" "$FONT_FILE_PATH" "$SUBTITLE_MODE"
