...
./main_capture.sh ./data/result/event1/result.mp4 ${PWD}/data/src/project/event1/narration.csv "ナレーションスタジオ\nなれスタ！\nBBS AIハッカソン 2024" ${PWD}/data/src/project/event1/tempra.png "Tempra\nTitans" ${PWD}/data/src/project/event1/capture.mp4 "voicepeak" | tee log/20250123_event1.log
