...
BASE_MOVIE_PATH=${1:-"${PWD}/data/src/project/sample/main_part/base.mp4"}  # ベース動画

CENTER_IMAGE_LIST_FILE_PATH=${2:-"${PWD}/data/src/project/sample/image_list_number.txt"}  # 中央に標示する画像のリスト
RT_OWNER_IMAGE_FILE_PATH=${3:-"${PWD}/data/src/project/sample/main_part/right_top.png"}
LT_THEME_IMAGE_FILE_PATH=${4:-"${PWD}/data/src/project/sample/main_part/left_top.png"}
RB_TOPIC_IMAGE_FILE_PATH=${5:-"${PWD}/data/src/project/sample/main_part/right_bottom.png"}
...
do
    ...
    # total_part_secの更新
    total_part_sec=$((total_part_sec + partSec))
