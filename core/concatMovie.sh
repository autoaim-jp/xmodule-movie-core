...
# タイトル動画とメインパート動画を結合する
ffmpeg -y -i $REENCODED_TITLE_MOVIE_FILE_PATH -i $REENCODED_MAIN_PART_MOVIE_FILE_PATH -filter_complex "[0:v:0][1:v:0]concat=n=2:v=1:a=0[v]" -map "[v]" $CONCAT_MOVIE_FILE_PATH
