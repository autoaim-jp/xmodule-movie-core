...
# input
# CENTER_IMAGE_LIST_FILE_PATH=${1:-"${SAMPLE_PROJECT_DIR_PATH}image_list_number.txt"}
CENTER_IMAGE_LIST_FILE_PATH=${1:-"${SAMPLE_PROJECT_DIR_PATH}image_list_number_only3.txt"}
BACKGROUND_IMAGE_FILE_PATH=${2:-"${SAMPLE_PROJECT_DIR_PATH}asset/background.jpg"}
...
# ベース動画作成
./core/createBasePartMovie.sh $BASE_PART_MOVIE_FILE_PATH $CENTER_IMAGE_LIST_FILE_PATH $BACKGROUND_IMAGE_FILE_PATH $RT_OWNER_IMAGE_FILE_PATH $LT_THEME_IMAGE_FILE_PATH $RB_TOPIC_IMAGE_FILE_PATH $LB_NARRATOR_IMAGE_FILE_PATH
